...
menuItem.forEach(item=>{
    item.addEventListener('click',()=>{
        ...
        document.querySelector('.carrier-section').style.display='none';
    })
})
...
document.querySelector('#carrier-menu').addEventListener('click',()=>{
    document.querySelector('.middle-container').style.display='none';
    document.querySelector('.carrier-section').style.display='block';
})
